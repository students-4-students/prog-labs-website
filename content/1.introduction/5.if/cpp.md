...
La grande majorité des algorithmes exécute du code différent en fonction de calculs précédents (par exemple,  s’il est 20h ou plus tard, alors on va dormir, sinon on travaille). Ce `si ... sinon ...` s’exprime avec ce qu’on appelle un branchement conditionnel.
